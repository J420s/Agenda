    ...
    <div class="row justify-content-center">
        <div class="col-md-6 align-self-center">
          ...
          <div class="row justify-content-center">
            ...
            <div class="col-md-2 text-center">
              <a href="index.php?page=<?= isset($_REQUEST['page']) ? $_REQUEST['page'] - 1 : 0 ?>">
                <img class="img-fluid" src="./buttons/arrow-left.png">
              </a>
            </div>
            <div class="col-md-2 text-center">
              <a href="index.php?page=<?= isset($_REQUEST['page']) ? $_REQUEST['page'] + 1 : 1 ?>">
                <img class="img-fluid" src="./buttons/arrow-right.png">
              </a>
            </div>
            <div class="col-md-2 text-center">
              <a href="index.php?page=<?=Number_Of_Pages?>">
